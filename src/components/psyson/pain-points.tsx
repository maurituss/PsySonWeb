...
const painPoints = [
  {
    ...
    description: "Los colaboradores no siempre conectan con propuestas desconectadas de sus valores y cosmovisión.",
  },
  {
    icon: TrendingDown,
    title: "Baja adopción",
    description: "Si el beneficio no genera confianza, la gente simplemente no lo usa y la inversión se pierde.",
  },
  {
    icon: Settings,
    title: "Complejidad operativa",
    description: "RR.HH. necesita una solución clara, confidencial y fácil de administrar sin fricción.",
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">
            No alcanza con ofrecer cualquier solución de salud mental
          </h2>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Muchas organizaciones quieren cuidar a su gente, pero encuentran opciones
            genéricas, poco alineadas con su cultura o difíciles de implementar.
          </p>
        </div>
