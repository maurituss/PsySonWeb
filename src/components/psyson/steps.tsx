        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="text-center">
              <div className="w-14 h-14 rounded-full bg-[var(--teal)] text-white font-bold text-xl flex items-center justify-center mx-auto">
                {step.number}
              </div>
              <h3 className="mt-5 font-semibold text-lg text-[var(--navy)]">{step.title}</h3>
