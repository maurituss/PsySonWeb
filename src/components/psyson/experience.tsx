    ...
    <section className="py-20 px-6 bg-[var(--warm-bg-alt)]">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-[var(--navy)] leading-tight">
            ...
            <ul className="mt-8 space-y-4">
              {steps.map((step) => (
                <li key={step} className="flex items-start gap-3">
                  <div className="shrink-0 mt-0.5 w-5 h-5 rounded-full bg-[var(--teal)] flex items-center justify-center">
          ...
          <div className="flex justify-center">
            <div className="w-72 bg-white rounded-3xl shadow-xl border border-gray-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full bg-[var(--teal-light)]" />
                <div>
                  <p className="text-sm font-semibold text-[var(--navy)]">Proxima sesion</p>
              ...
              <div className="bg-[var(--warm-bg)] rounded-xl p-4 mb-4">
                ...
                <p className="text-sm font-semibold text-[var(--navy)]">Lic. Maria Gonzalez</p>
                <p className="text-xs text-gray-500">Psicologia clinica · 12 anos exp.</p>
              </div>

              <div className="space-y-2">
                <div className="bg-[var(--teal)] text-white rounded-xl py-3 text-center text-sm font-semibold">
                  Unirme a sesion
                </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-2 text-center">
                <div className="bg-gray-50 rounded-lg py-2">
                  ...
                  <p className="text-sm font-bold text-[var(--navy)]">8</p>
                </div>
                <div className="bg-gray-50 rounded-lg py-2">
                  <p className="text-xs text-gray-500">Racha</p>
                  <p className="text-sm font-bold text-[var(--navy)]">4 sem</p>
                </div>
                <div className="bg-gray-50 rounded-lg py-2">
                  <p className="text-xs text-gray-500">Animo</p>
                  <p className="text-sm font-bold text-[var(--teal)]">😊</p>
                </div>
              </div>
            </div>
          </div>
